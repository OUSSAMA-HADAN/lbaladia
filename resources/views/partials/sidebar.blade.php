...
<div class="d-flex">
    <div class="row">
        <!-- Sidebar -->
        <div class="col-md-3 col-lg-2 p-0 bg-dark text-light w-100" style="background-color: #d9d9d9 !important;">
            <div class="d-flex flex-column vh-100 ms-2 sidebar1"><br><br><hr>
                <div class="list-group flex-grow-1 mt-auto p-3 button1"><br>
                    ...
                    <a href="#" class="list-group-item list-group-item-action" style="background-color: #e48e1e !important;">Reports</a><br>
